...
— название бытовой техники (например: Посудомоечные машины)  
— алиас техники (например: /posudomoyka/)  
Используй их строго по назначению. Не придумывай данные, если они не были переданы.
